...
public class QuickList<K, V> {
    ...
    /**
     * Add a pair temp-temp to the first list if it's size is less than 5
     * otherwise the last temp of the first list will become the head of the
     * second list, function returns true
     *
     * @param key
     * @param value
     * @return
    ...
    /**
     * Returns the link associate with the key. The link switch position with
     * its previous if it was on the first list otherwise it becomes the head of the
     * second list.
     *
     * @param key
     * @return
    ...
    /**
     * Returns the temp associate with the temp The temp switch position with
     * its previous if it was on the first list otherwise we put it on the top
     * of the first list.
     *
     * @param value
     * @return
    ...
    /**
     * Set the value of the link with the new value passes as parameter returns
     * the old value, link switches position with its previous
     *
     * @param key
     * @param value
     * @return
    ...
    /**
     * Returns true if the link exists. The link switch position with its
     * previous if they are in the first list otherwise the link switch for the
     * top of the first list if we found it in the second list
     *
     * @param key
     * @return
     */
    ...
    /**
     * Delete the Link associate with the key returns the value of the link
     *
     * @param key
     * @return
     */
    ...
    /**
     * Delete the temp associate with the temp Returns true if the value is
     ...
     * @return
     */
    private Link<K, V> addLinkToList(K key, V value, Link<K, V> head) {
        
        return  new Link<>(key, value, head);
    }
    ...
    /**
     * Returns the link before the last link of the first list
     *
     * @return
     */
    ...
    private boolean hasTheKey(K key) {
    ...
    private V deleteKeyInTheList(K key, V value, Link<K, V> head) {
        ...
        if (link != null) {
            // could be the head of the first list or the second list
            if (link.key.equals(head.key)) { 
                if (link.key.equals(first_head.key)) {
                    first_head = first_head.next;
                    // we decremented by adding link on the first list and incremented when we deleted
                    ++first_size; 
                } else {
                    second_head = second_head.next;
                    --second_size;
    ...
    /**
     * This method returns the previous link if there's a link which has the
     * temp or the value in the list.
     *
     * @param key
     * @param value
     * @return
    ...
    /**
     * Returns the previous temp before the temp or temp that passes as
     * parameter
     *
     * @param key
     * @param value
